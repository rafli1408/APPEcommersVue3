            ...
            <div class="container">
                <div class="flex items-center justify-between relative">
                    ...
                    <div class="flex items-center">
                        ...
                        <!-- NAVBAR -->
                        <nav id="nav-menu"
                            class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full  right-4 top-full lg:block lg:static lg:max-w-full lg:bg-transparent lg:shadow-none lg:rounded-none lg:dark:bg-transparent dark:bg-dark dark:shadow-slate-500">
                            <ul class="block lg:flex">
                                ...
                                <li class="group relative">
                                    <RouterLink to="/keranjang"
                                        ...
                                        <span
                                            class="bg-transparent px-2 rounded-full absolute top-0 -mt-2 left-[120px] lg:-mt-2 lg:left-[100px] ">{{ updateKeranjang
                                                ? updateKeranjang.length : jumlah_pasanans.length }}</span>
                                    </RouterLink>
                                </li>
                            </ul>
                        </nav>
...
export default {
    ...
    mounted() {
        axios.get('https://localhost:7038/api/CartDetail')
